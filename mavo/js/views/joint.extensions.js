...
joint.shapes.basic.Intention = joint.shapes.basic.Generic.extend({
	markup: '<g class="rotatable"><g class="scalable"><rect class="outer"/></g><path class="satvalue"/><text class="mavo"/><text class="name"/></g>',
...
joint.shapes.basic.Task = joint.shapes.basic.Intention.extend({
    markup: '<g class="rotatable"><g class="scalable"><path class="outer"/></g><path class="satvalue"/><text class="mavo"/><text class="name"/></g>',
    defaults: joint.util.deepSupplement({
        type: "basic.Task",
        attrs: {
            ".outer": {
